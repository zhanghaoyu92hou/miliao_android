...
public class JCVideoViewbyXuan extends FrameLayout implements OnJcvdListener {
    private String TAG = "JCVideoViewbyXuan";
    ...
    public void play(String url) {
        Log.e(TAG, "play: " + url + "    state :" + mCurrState);
