...
public class VoiceAnimViewCollection extends RelativeLayout {
    ...
    public VoiceAnimViewCollection(Context context) {
        this(context, null);
    }

    public VoiceAnimViewCollection(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VoiceAnimViewCollection(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.view_voice_anim_collection, this);
    }
    ...
    private void setChatDirection(boolean direction) {
        ...
        tvTime = findViewById(R.id.voice_time_tv);
    ...
    private void bindData(boolean direction, String id,
        ...
        if (length > 9) {
            tvTime.setText("00:" + length);
        } else {
            tvTime.setText("00:0" + length);
        }
            ...
            Downloader.getInstance().addDownload(content, new DownloadListener() {
                ...
                public void onComplete(String uri, String filePath, View view) {
                    ...
                    if (clickStart) {
                        ...
                        startAnim();
                        VoicePlayerCollection.instance().changeVoice(VoiceAnimViewCollection.this);
                    }
                }
    ...
    private void initListener() {
        mSeekBar.addOnProgressChangeListener(new XSeekBar.OnProgressChangeListener() {
            ...
            public void onProgressChanged(int progress) {
                int mesc = progress;
                VoicePlayerCollection.instance().playSeek(mesc, VoiceAnimViewCollection.this);
