...
import com.iimm.miliao.ui.dialog.ChangeRoomNameDialogView;
import com.iimm.miliao.ui.dialog.CommonDialog;
import com.iimm.miliao.ui.dialog.QRcodeDialogView;
import com.iimm.miliao.ui.dialog.SingleInputDialogView;
import com.iimm.miliao.ui.dialog.TowInputDialogView;
import com.iimm.miliao.util.ToastUtil;
import com.iimm.miliao.view.CustomizeProgressDialog;
...
public class DialogHelper {
    ...
    public static InputFilter mExpressionFilter = new InputFilter() {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            ...
            if (emojiMatcher.find()) {
                ToastUtil.showToast(MyApplication.getContext(), R.string.tip_not_support_emoji);
                return "";
            }
            return null;
        }
    ...
    public static InputFilter mChineseEnglishNumberFilter = new InputFilter() {
        ...
        public CharSequence filter(CharSequence charSequence, int i, int i1, Spanned spanned, int i2, int i3) {
            ...
            if (!matcher.find()) {
                ...
                ToastUtil.showToast(MyApplication.getContext(), R.string.tip_chinese_english_number);
                return "";
            }
        }
    };
    ...
    public static void ChangeRoomNameDialog(Activity activity, String title, String hint, int maxLine, int line, int maxLength, View.OnClickListener onClickListener) {
        new ChangeRoomNameDialogView(activity, title, hint, maxLine, line, new InputFilter[]{new InputFilter.LengthFilter(maxLength)}, onClickListener).show();
    }
    ...
    public static void showLimitSingleInputDialog(Activity activity, String title, String hint, View.OnClickListener onClickListener) {
        new ChangeRoomNameDialogView(activity, title, hint, 20, 2, new InputFilter[]{new InputFilter.LengthFilter(400)}, onClickListener).show();
    }

    public static void showQRDialog(Activity activity, String title, String number, String website, String id, Friend friend) {
        QRcodeDialogView qRcodeDialogView = new QRcodeDialogView(activity, title, number, website, id, friend);
        qRcodeDialogView.show();
    }

    public static void showQRDialog2(Activity activity, String title, String number, String website, String id, Friend friend, CoreManager coreManager) {
        QRcodeDialogView qRcodeDialogView = new QRcodeDialogView(activity, title, number, website, id, friend, coreManager);
        qRcodeDialogView.show();
    }
    ...
    public static void verify(Context ctx, String title, String hint, QuickReplyDialog.VerifyClickListener listener) {
        QuickReplyDialog dialog = new QuickReplyDialog(ctx);
    ...
    public static TitleErrorDialog inputTitle(Context ctx, String title, String hint, TitleErrorDialog.VerifyClickListener listener) {
        TitleErrorDialog dialog = new TitleErrorDialog(ctx);
        dialog.setVerifyClickListener(title, hint, listener);
        dialog.setOkButton(android.R.string.ok);
        dialog.show();
        dialog.showTitle(title);
        return dialog;
    }
    ...
    public static void commonDialog(Activity activity, String title, String hint, View.OnClickListener onClickListener) {
        new CommonDialog(activity, title, hint, onClickListener).show();
        ;

    }

    public static AddBankCardDialog showAddBankCardDialog(Activity context, AddBankCardDialog.AddBankCardSureListener listener) {
        AddBankCardDialog addBankCardDialog = new AddBankCardDialog(context, listener);
        addBankCardDialog.show();
        return addBankCardDialog;
    }
