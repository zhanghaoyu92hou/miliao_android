        ...
        switch (v.getId()) {
            case R.id.qq:
                if ((AppUtils.isAppInstalled(mContent, "com.tencent.mtt"))) {
                    ...
                    ToastUtil.showToast(mContent, R.string.tip_no_qq_browser);
                }
                break;
            case R.id.uc:
                if ((AppUtils.isAppInstalled(mContent, "com.uc.browser"))) {
                    ...
                    ToastUtil.showToast(mContent, R.string.tip_no_uc_browser);
                }
                break;
            case R.id.op:
                if ((AppUtils.isAppInstalled(mContent, "com.opera.mini.android"))) {
                    ...
                    ToastUtil.showToast(mContent, R.string.tip_no_opera_browser);
                }
                break;
            case R.id.local:
                // 本地浏览器打开
                ...
                try {
                    ...
                    // 可能url有问题，比如是file协议的，
                    // 也可能根本没有浏览器，
                    ToastUtil.showToast(mContent, R.string.tip_no_local_browser);
                }
                break;
        }
    }
