...
public class DeleteDialog extends BaseCommonBottomDialog implements View.OnClickListener {

    TextView mTvTakingPhotos;
    TextView mTvChoosePicture;
    TextView mTvCancel;

    public DeleteDialog(Context context, GetPictureCommonDialogListener listener) {
