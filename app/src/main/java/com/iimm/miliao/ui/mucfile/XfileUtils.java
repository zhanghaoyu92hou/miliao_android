...
public class XfileUtils {
    private static String TAG = "XfileUtils";
    ...
    public static int measureViewHeight(View v) {
        ...
        Log.e(TAG, "measureViewHeight: " + height);
        return height;
    }
    ...
    public static boolean isNotChatVisibility(int type) {
        ...
        if (type == Constants.TYPE_READ) { // 已读消息还是要保存的， 不让它查询出来就行了
            b = false;
            ...
            b = true;
                ...
                || type == Constants.TYPE_CLOUD_RECEIVE_RED
                || type == Constants.TYPE_CLOUD_TRANSFER
                || type == Constants.TYPE_CLOUD_TRANSFER_RECEIVE
                || type == Constants.TYPE_CLOUD_TRANSFER_RETURN) {
            b = false;
        } else if (type > 100) {
            b = true;
            if (type == Constants.TYPE_END_CONNECT_VOICE) {
                b = false;
            } else if (type == Constants.TYPE_NO_CONNECT_VIDEO) {
                b = false;
            } else if (type == Constants.TYPE_END_CONNECT_VIDEO) {
                b = false;
            } else if (type == Constants.TYPE_NO_CONNECT_VOICE) {
                b = false;
            } else if (type == Constants.TYPE_IS_MU_CONNECT_VOICE) {
                b = false;
            } else if (type == Constants.TYPE_IS_MU_CONNECT_VIDEO) {
                b = false;
            } else if (type == Constants.TYPE_SAYHELLO) {
                b = false;
            } else if (type == Constants.TYPE_FEEDBACK) {
                b = false;
            } else if (type == Constants.TYPE_CUSTOM_CHANGE_READ_DEL_TIME) {
                b = false;
            } else if (type == Constants.TYPE_GROUP_SIGN) {
                b = false;
