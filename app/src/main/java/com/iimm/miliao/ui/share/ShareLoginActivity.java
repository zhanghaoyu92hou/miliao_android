...
import com.iimm.miliao.ui.account.DataDownloadActivity;
...
public class ShareLoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        findViewById(R.id.llThirdLogin).setVisibility(View.INVISIBLE);
        ...
        if (PreferenceUtils.getInt(ShareLoginActivity.this, AppConstant.LOGIN_TYPE) == 1) {
