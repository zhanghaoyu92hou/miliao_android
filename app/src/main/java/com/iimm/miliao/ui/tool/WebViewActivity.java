...
//        mWebView.getSettings().setDatabaseEnabled(true);
        ...
        mTitleRightIv.setOnClickListener(view -> {
            WebMoreDialog mWebMoreDialog = new WebMoreDialog(WebViewActivity.this, getCurrentUrl(), new WebMoreDialog.BrowserActionClickListener() {
                ...
                public void shareWechat() {
                    ...
                    if (AppUtils.isContextExisted(WebViewActivity.this)) {
                        ShareSdkHelper.shareWechat(
                                WebViewActivity.this, title, url, url, coreManager.getConfig().wechatAppId
                        );
                    }
                }
                ...
                @Override
                public void shareQQ() {
                    AndPermissionUtils.AuthorizationStorage(WebViewActivity.this, WebViewActivity.this);
                }
            });
            mWebMoreDialog.show();
        });
    ...
    private void showFloating() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M
            ...
            PermissionDialog.show(WebViewActivity.this, "悬浮窗权限", "您的手机没有授予悬浮窗权限，请开启后再试", "暂不开启", "现在去开启");
        }
    }
    ...
    public IUiListener qqShareListener = new IUiListener() {
        ...
        public void onComplete(Object response) {
            ...
            ToastUtil.showToast(WebViewActivity.this, response.toString());
        }

        @Override
        public void onError(UiError e) {
            // TODO Auto-generated method stub
            ToastUtil.showToast(WebViewActivity.this, e.errorMessage);
        }
    };
    ...
    public void onSuccess() {
        ...
        mTencent = Tencent.createInstance(BuildConfig.QQ_APP_ID, WebViewActivity.this);
        String title = mTitleTv.getText().toString().trim();
        String url = getCurrentUrl();
        ShareSdkHelper.shareQQ(mTencent, WebViewActivity.this, title,
                url,
