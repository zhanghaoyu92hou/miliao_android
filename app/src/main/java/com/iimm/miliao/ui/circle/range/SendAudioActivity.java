...
import com.iimm.im.audio.MessageEventVoice;
import com.iimm.im.audio.VoiceRecordActivity2;
 ...
 * 发布音频
 */
public class SendAudioActivity extends BaseActivity implements View.OnClickListener, OnPermissionClickListener {
    ...
    private void initView() {
        ...
        mIconImageView.setBackgroundResource(R.drawable.add_voice2);
...
//        mReleaseBtn.setText(InternationalizationHelper.getString("JX_Publish"));
    ...
    private void initEvent() {
        ...
        mFloatLayout.setOnClickListener(v -> AndPermissionUtils.recordingPermission(SendAudioActivity.this, SendAudioActivity.this));
    }
    ...
    private class UploadTask extends AsyncTask<Void, Integer, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            String result = new UploadService().uploadFile(SendAudioActivity.this, coreManager, mapParams, dataList);
    ...
    public void onFailure(List<String> data) {
        ToastUtil.showToast(SendAudioActivity.this, getString(R.string.please_turn_on_recording_permission));
    }
}
