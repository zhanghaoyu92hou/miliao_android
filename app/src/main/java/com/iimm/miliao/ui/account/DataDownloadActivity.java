...
import com.iimm.miliao.ui.share.AuthorizationActivity;
import com.iimm.miliao.ui.share.ShareConstant;
import com.iimm.miliao.ui.share.ShareNearChatFriend;
                                ...
                                FriendDao.getInstance().addRooms(mHandler, mLoginUserId, result.getData(), new OnCompleteListener2() {
                                    ...
                                    public void onCompleted() {
                                        c.uiThread(r -> {
                                            ...
                                            if (user_friend_download_status != STATUS_SUCCESS) {  //群组下载完成 再下载好友
                                                downloadUserFriend();
                                            }
                                            endDownload();
                                        });
