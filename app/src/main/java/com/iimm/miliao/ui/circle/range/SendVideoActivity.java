...
public class SendVideoActivity extends BaseActivity implements View.OnClickListener, OnPermissionClickListener {
    ...
    private void initView() {
        ...
        mIconImageView.setBackgroundResource(R.drawable.add_video2);
    ...
    private void initEvent() {
        ...
        mFloatLayout.setOnClickListener(v -> AndPermissionUtils.Authorization(SendVideoActivity.this, SendVideoActivity.this));
...
//        });
    ...
    private class UploadTask extends AsyncTask<Void, Integer, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            String result = new UploadService().uploadFile(SendVideoActivity.this, coreManager, mapParams, dataList);
