...
import com.iimm.miliao.ui.mucfile.bean.DownBean;
...
import static com.iimm.miliao.ui.mucfile.DownManager.STATE_DOWNLOADED;
import static com.iimm.miliao.ui.mucfile.DownManager.STATE_DOWNLOADFAILED;
import static com.iimm.miliao.ui.mucfile.DownManager.STATE_UNDOWNLOAD;
import static com.iimm.miliao.ui.mucfile.DownManager.STATE_WAITINGDOWNLOAD;
...
public class MucFileDetails extends BaseActivity implements DownManager.DownLoadObserver, View.OnClickListener {
    ...
    private void open() {
        File file = new File(FileUtil.getFileDownDir(), data.getName());
    ...
    public void onDownLoadInfoChange(final DownBean info) {
        ...
        switch (info.state) {
            case STATE_DOWNLOADED:
                ...
                FileUtil.updatePhotoMedia(new File(FileUtil.getFileDownDir(), info.name));
                break;
            case STATE_UNDOWNLOAD:
                //                tvSize.setText("未下载");
