...
import com.iimm.miliao.audio.RecordManager;
...
public class JsSdkInterface {
    ...
    public void chooseSKPayInApp(String param) {
        ...
        if (!TextUtils.isEmpty(param)) {
            ...
            if (listener != null) {
                listener.onChooseChtatPayInApp(appId, prepayId, sign);
            }
        }
    }
    ...
    public void updateShareData(String param) {
        ...
        try {
            ...
            ShareBean bean = JSON.parseObject(content, ShareBean.class);
            if (bean == null
    ...
    public interface Listener {
        ...
        void onChooseChtatPayInApp(String appId, String prepayId, String token);
    }
