...
public class FragmentPayDialog extends DialogFragment {
    ...
    private void initView(View rootView) {
        ...
        title.setText(InternationalizationHelper.getString("CREDIT_LOW"));
        message.setText(InternationalizationHelper.getString("INSUFFCIENT_RECHARGE"));
        positiveBn.setText(InternationalizationHelper.getString("RECHARGE"));
        negtiveBn.setText(InternationalizationHelper.getString("JX_Cencal"));
    }
