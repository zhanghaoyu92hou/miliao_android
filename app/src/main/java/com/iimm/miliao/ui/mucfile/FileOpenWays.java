...
public class FileOpenWays {
    ...
    public Intent showOpenTypeDialog(String filePath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            uri = FileProvider.getUriForFile(mContext, mContext.getPackageName() + Constants.FILE_PROVIDER_AUTHORITY, file);
    ...
    public void openFiles(String filesPath) {
        ...
        if (!TextUtils.equals(type, "*/*")) {
            try {
                ...
                ToastUtil.showToast(R.string.cannot_open_file_without_related_app);
            } catch (Exception e) {
            }
        } else {
            try {
