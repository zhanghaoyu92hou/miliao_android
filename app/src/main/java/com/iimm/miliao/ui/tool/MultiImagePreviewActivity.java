        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(com.iimm.miliao.broadcast.OtherBroadcast.singledown)) {
                ...
                if (TextUtils.isEmpty(imageUrl)) {
                    ToastUtil.showToast(MultiImagePreviewActivity.this, InternationalizationHelper.getString("JX_ImageIsNull"));
                    return;
                }
                                                    ...
                                                    public void run() {
                                                        ...
                                                        mViewPager.post(() -> {
                                                            if (result != null && !TextUtils.isEmpty(result.getText())) {
                                                                ...
                                                                ToastUtil.showToast(MultiImagePreviewActivity.this, R.string.decode_failed);
                                                            }
                                                        });
                                                    }
                                                });
