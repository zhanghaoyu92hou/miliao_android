 ...
 * @time 2020-06-03
 */
public class SearchUserHorizontalAdapter extends RecyclerView.Adapter<SearchUserHorizontalAdapter.SearchUserHolder> {
    ...
    public SearchUserHorizontalAdapter(Context context, List<Friend> friends) {
        mContext = context;
        mFriends = friends;
    }
    ...
    public SearchUserHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_search_user_horizontal, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull SearchUserHolder holder, int i) {
        ...
        ImageUtils.loadSignalAvatarWithUrl(MyApplication.getContext(), AvatarHelper.getAvatarUrl(mFriends.get(i).getUserId(), false), holder.ivHeadImg, mFriends.get(i).getUserId());
