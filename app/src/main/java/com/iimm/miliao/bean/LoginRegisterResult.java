...
public class LoginRegisterResult {
    ...
    private int inviteStatus;//为2的时候，需要绑定邀请码
    private Login login;
    private Settings settings;
    private int payPassword; // 是否已经设置了支付密码，
    private int registerStatus;//1第一次登录
    ...
    public String getSerInviteCode() {
        return serInviteCode == null ? "" : serInviteCode;
    }

    public void setSerInviteCode(String serInviteCode) {
        this.serInviteCode = serInviteCode;
    }
