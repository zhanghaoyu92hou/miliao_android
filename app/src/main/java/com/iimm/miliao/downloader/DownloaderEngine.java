...
class DownloaderEngine {
    ...
    private Map<String, DownLoadingInfo> cacheMap;
    ...
    public void submitUri(String uri, DownLoadingInfo downLoadingInfo) {
        if (cacheMap == null) {
            cacheMap = new ConcurrentHashMap<>();
        }
        cacheMap.put(uri, downLoadingInfo);
    }
    ...
    public boolean containCacheByUri(String uri) {
        if (cacheMap == null) {
            return false;
        } else if (cacheMap.containsKey(uri)) {
            return true;
        } else {
            return false;
        }
