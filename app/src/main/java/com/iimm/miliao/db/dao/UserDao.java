...
public class UserDao {
    ...
    public void updateTelephone(String userId, String value) {
        updateColumnValue(userId, "telephone", value);
    }

    public void updatePhone(String userId, String value) {
        updateColumnValue(userId, "phone", value);
    }

    public void updatePassword(String userId, String value) {
        updateColumnValue(userId, "password", value);
    }
