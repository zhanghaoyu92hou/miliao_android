...
import com.iimm.miliao.ui.me.LogActivity;
...
public final class LogUtils {
    ...
    private static boolean sLogEnable = BuildConfig.LOG_DEBUG;
    ...
    public static void logMessage(Context context, String message) {
        Intent intent = new Intent(LogActivity.LOG_TEXT_ACTION);
        intent.putExtra(LogActivity.LOG_TEXT_EXTRA, message);
        if (context != null) {
            context.sendBroadcast(intent);
            FileController.getFileControl().writeToLogFile(message + "\n\n");
        }
    }
}
