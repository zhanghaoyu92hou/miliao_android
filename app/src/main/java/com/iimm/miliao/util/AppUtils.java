...
public class AppUtils {
    ...
    public static boolean isAppForeground(Context context) {
        ...
        if (!tasks.isEmpty()) {
            ...
            if (!topActivity.getPackageName().equals(context.getPackageName())) {
                Log.e(TAG, "app是否处于前台: false");
                return false;
            }
        }

        Log.e(TAG, "app是否处于前台:  true");*/
        Log.e(TAG, "app是否处于前台:  " + isForeground);
        return isForeground;
    }
    ...
    public static boolean isAppForeground1(Context context) {
        ...
        if (runningAppProcessInfoList == null) {
            Log.e(TAG, "isAppForeground: runningAppProcessInfoList false");
            return false;
        }
        ...
        for (ActivityManager.RunningAppProcessInfo processInfo : runningAppProcessInfoList) {
            if (processInfo.processName.equals(context.getPackageName()) && processInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                Log.e(TAG, "isAppForeground:  true" + processInfo.processName);
                return true;
            }
        }

        Log.e(TAG, "isAppForeground:  false");
        return false;
    }
