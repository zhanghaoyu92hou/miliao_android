...
public class StringUtils {
    ...
    static Pattern phoneNumberPat = Pattern.compile("^1[3456789]\\d{9}$");//Pattern.compile("^((13[0-9])|(147)|(15[0-3,5-9])|(17[0,6-8])|(18[0-9]))\\d{8}$");
...
*/
    ...
    public static boolean isPhone(final String phoneNum) {
        ...
        return phoneNumberPat.matcher(phoneNum).matches();
    }
    ...
    public static String getMsgContent(ChatMessage chatMessage) {
        ...
        if (type == Constants.TYPE_TEXT) {
        ...
        } else if (type >= Constants.TYPE_IS_CONNECT_VOICE
                && type <= Constants.TYPE_EXIT_VOICE) {
            ...
            text = MyApplication.getContext().getString(R.string.msg_red_packet_exclusive);
