...
public class DisplayUtil {
    ...
    public static void setRightOkStyle(Context context, TextView tvRight, String string) {
        tvRight.setBackgroundResource(R.drawable.bg_tight_tv);
        tvRight.setTextSize(14);
        tvRight.setTextColor(context.getResources().getColor(android.R.color.white));
        tvRight.setText(string);
    }


    public static void setRightOkStyle(Context context, TextView tvRight, int stringId) {
