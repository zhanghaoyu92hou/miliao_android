...
public class UserSp extends CommonSp {
    ...
    private static final String KEY_SAlt = "salt";//登录加密随机数
    ...
    //Salt
    public String getSalt(String defaultValue) {
        return getValue(KEY_SAlt, defaultValue);
    }

    public void setSalt(String value) {
        setValue(KEY_SAlt, value);
    }
