...
public class GetNoSecretBuilder extends BaseBuilder {

    @Override
    public GetNoSecretBuilder url(String url) {
    ...
    @Override
    public GetNoSecretBuilder tag(Object tag) {
        return this;
    }
    ...
    @Override
    public GetNoSecretBuilder params(String k, String v) {
        try {
    ...
    public GetNoSecretBuilder params(Map<String, String> params) {
        for (String key : params.keySet()) {
